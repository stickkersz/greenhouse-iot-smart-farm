# Archive — pre-build planning docs

เอกสารในโฟลเดอร์นี้ทั้งหมดเขียนขึ้น **ก่อน** ระบบถูกสร้างจริง (กลางเดือนมิถุนายน 2569) เก็บไว้เป็นประวัติ
...
| `pinout.docx`, `pinout.pdf` | Pinout ฉบับเก่า — เวอร์ชัน current คือ `pinout_v2.md` ที่ root |
