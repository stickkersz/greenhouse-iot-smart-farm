...
- [x] LCD I2C แก้แล้ว ✅ (2026-07-08) — จอตัวเดิมเสีย เปลี่ยนจอใหม่ต่อสายเดิมทำงานปกติ
- [x] ยืนยันแล้วว่า noise ปั๊มรบกวน DHT22/ระบบเป็น hardware ไม่ใช่ firmware (A/B test 2026-07-03) —
  ต้องแก้: cap คร่อมมอเตอร์ปั๊ม + RC snubber CH4 + แยกสายไฟกำลัง/สัญญาณ (2026-07-08: ทดสอบเทียบ
  DS18B20 vs DHT22 ยืนยันว่าระยะห่างจากกลุ่ม relay สำคัญกว่าคุณภาพจุดต่อ — ดู PROJECT_MEMORY.md §15)
